...
(function (BABYLON) {
    var GLTFMaterialsPbrExtension = (function (_super) {
        ...
        GLTFMaterialsPbrExtension.prototype.loadMaterialAsync = function (gltfRuntime, id, onSuccess, onError) {
            ...
            switch (materialPbrExt.materialModel) {
                case "PBR_specular_glossiness":
                    ...
                    break;
                default:
                    BABYLON.Tools.Error(this.name + " of material '" + id + "' specifies an unsupported technique '" + materialPbrExt.technique + "'");
                    onError();
                    break;
            }
            return true;
        ...
        GLTFMaterialsPbrExtension.prototype._loadNormalMap = function (gltfRuntime, materialId, textureId, textureScale, pbrMaterial) {
            var onSuccess = function (texture) {
                pbrMaterial.bumpTexture = texture;
                pbrMaterial.bumpTexture.level = textureScale;
            };
            var onError = function () {
                BABYLON.Tools.Error("Normal map texture '" + textureId + "' of PBR material '" + materialId + "' failed to load");
            };
            BABYLON.GLTFFileLoaderExtension.LoadTextureAsync(gltfRuntime, textureId, onSuccess, onError);
        };
            ...
            for (var val in materialPbrExt.values) {
                ...
                switch (val) {
                    ...
                    case "specularGlossinessTexture":
                        ...
                        break;
                    case "normalMap":
                        this._loadNormalMap(gltfRuntime, id, value.texture, value.scale, pbrMaterial);
                        break;
                }
            }
            return pbrMaterial;
...
(function (BABYLON) {
    ...
    var GLTFCompressedTextureExtension = (function (_super) {
        ...
        function GLTFCompressedTextureExtension() {
            _super.call(this, "KHR_compressed_texture");
        }
    ...
    var CompressedRawTexture = (function (_super) {
        ...
        function CompressedRawTexture(data, width, height, compression, scene, generateMipMaps, invertY, samplingMode) {
            ...
            this._texture = scene.getEngine().createRawTexture(data, width, height, 0, generateMipMaps, invertY, samplingMode, compression);
